-- Internship platform schema (UUID-based) - Simplified model
...
CREATE INDEX idx_internships_status ON internships(moderation_status);
...
CREATE INDEX idx_task_remarks_user_id ON task_remarks(user_id);
